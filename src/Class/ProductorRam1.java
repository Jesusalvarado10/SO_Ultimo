 ...
 * @author gabga
 */
public class ProductorRam1 extends Empleados{
    
    public ProductorRam1(int id,Almacen almacen,int Unidades) {
        super(26, id,"Ram",almacen,Unidades);
    }
    ...
    public void run(){
        while(true){
           ...
           if(this.diaspro>2){
//               System.out.println("Empleado de ram ha producido en el dia "+ this.diaspro);
