...
public class Empresa1 {
    ...
    public Empresa1(String nombre,ProyectManager pm,Director director,ProductorPlaca ListaP[],ProductorFuente ListaF[],ProductorCPU ListaC[],ProductorTarjetaG ListaT[],ProductorRam ListaR[],Ensamblador ensamblador_,Almacen almacen){
        this.Nombre=nombre;
        this.Ganancias=0;
        this.Perdidas=0;
